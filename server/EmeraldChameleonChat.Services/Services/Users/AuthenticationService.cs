...
namespace EmeraldChameleonChat.Services.Services.Users
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        private string GenerateAccessToken(IEnumerable<Claim> claims)
        {
            ...
            var expiry = DateTime.UtcNow.AddMinutes(int.Parse(_config["Jwt:Expiry:Access"]));
        ...
        private async Task<string> GenerateRefreshToken(User registeredUser, IEnumerable<Claim> claims, CancellationToken cancellationToken)
        {
            ...
            var expiry = DateTime.UtcNow.AddDays(int.Parse(_config["Jwt:Expiry:Refresh"]));
            ...
            {
                throw new Exception("Failed to write Refresh Token", ex);
            }
